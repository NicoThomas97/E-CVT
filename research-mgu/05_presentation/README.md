...
`research-mgu/05_presentation/content_versions/ecvt_mgu_ring_layers_v4.md`
...
- 哪些整车场景中这些痛点最集中。
- 相比电子外变、花鼓 CVT/内变、有级齿轮箱 MGU、普通中置电机，哪些价值可以被替代，哪些仍可能保留。
...
5. `适合场景`：收束到 eMTB、载货/家庭工具车、高端多用途车/长途通勤和边界场景。
